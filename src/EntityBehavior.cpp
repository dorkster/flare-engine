...
void EntityBehavior::checkMoveStateMove() {
	...
	if (pc->stats.alive && ((target_dist < e->stats.melee_range && !fleeing && e->stats.in_combat && los) || (move_to_safe_dist && target_dist >= e->stats.flee_range) || stop_fleeing || ally_targeting_hero)) {
		if (stop_fleeing) {
